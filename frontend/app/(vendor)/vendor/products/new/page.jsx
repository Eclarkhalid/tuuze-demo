// frontend/app/(vendor)/vendor/products/new/page.jsx
"use client";
...
export default function CreateProduct() {
  ...
  // Fetch store data to check if store exists and is verified
  useEffect(() => {
      ...
      try {
        ...
        if (res.ok) {
          ...
          if (
            ...
            data.data.store.categories.length > 0
          ) {
            setCategories(data.data.store.categories);
          }
        } else {
      ...
      <div className="container mx-auto py-8 max-w-3xl">
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Your store needs to be verified before you can add products.
            </CardDescription>
          </CardHeader>
